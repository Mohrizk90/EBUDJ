...
const Notification = ({ notification, onRemove }) => {
  ...
  const getTypeClasses = () => {
    switch (notification.type) {
      case 'success':
        return 'notification-success border-green-200 bg-green-50';
      case 'error':
        return 'notification-error border-red-200 bg-red-50';
      case 'warning':
        return 'notification-warning border-yellow-200 bg-yellow-50';
      default:
        return 'notification-info border-blue-200 bg-blue-50';
    }
  };

  return (
    <div
      className={`notification ${getTypeClasses()} transform transition-all duration-300 ease-out ${
